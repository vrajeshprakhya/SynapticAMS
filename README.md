...
## Transient-Based Parameter Extraction (Fallback)

The pipeline includes **automatic fallback** to transient-based gm/gds extraction when standard DC operating point analysis fails:

...
def spice_to_verilog_ams(netlist_text, output_dir='.'):
    ...
    for i, block in enumerate(small_signal_blocks):
        ...
        try:
            ...
            # Extract AC parameters using flat_netlist (subcircuit BJTs are only
            # visible as individual devices after flattening). Falls back to
            # transient-based extraction if .OP convergence fails.
            ac_params = None
            ...
            try:
                ...
                # .OP method failed — try transient fallback
